...
| | | |
|:--|:--|:--|
| [1. 约定](#1-约定) | [2. 快速索引](#2-快速索引) | [3. 系统](#3-系统) |
| [4. 工作台日志](#4-工作台日志) | [5. 策略查询](#5-策略查询--行业映射) | [6. 详情 / 延期](#6-策略详情--延期提交--撤回) |
| [7. 策略审核](#7-策略审核) | [8. 延期托管](#8-策略延期托管) | [9. 游戏定投](#9-游戏优质媒体定投) |
| [10. 定向屏蔽](#10-定向屏蔽) | [11. 数据集](#11-数据集kwaibi) | [12. DataAgent](#12-dataagent旁路) |
| [13. 效果监控壳](#13-策略效果监控占位壳) | [14. 调用示例](#14-调用示例) | |
